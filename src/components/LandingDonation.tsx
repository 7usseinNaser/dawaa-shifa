...
export default function LandingDonation() {
  ...
  // Short rotating preview — 3 items from the full shared list
  const teaserVerses = [donationVerses[0], donationVerses[3], donationVerses[16]];
    ...
    <section className="py-20 px-4 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative">
        ...
        <div className="grid md:grid-cols-2 gap-6 items-stretch">
          {/* Verse Carousel — pulls from the same shared array */}
          <motion.div
