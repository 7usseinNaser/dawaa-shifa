...
import {
  Users, Plus, Pill, Clock, Trash2, Loader2, X, Heart, Baby, User,
} from 'lucide-react';
                  ...
                  {showMedForm === m.id && (
                    <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} exit={{ opacity: 0, height: 0 }} className="space-y-2 overflow-hidden">
                      ...
                      <div className="flex gap-2">
                        ...
                        <input value={medForm.times} onChange={(e) => setMedForm({ ...medForm, times: e.target.value })} placeholder={isRTL ? 'الأوقات' : 'Times'} className="flex-1 glass-card p-2.5 text-sm font-tajawal focus:outline-none focus:border-brand-green" />
                      </div>
                      <div className="flex gap-2">
                        ...
                        <input type="number" value={medForm.pillsPerDay} onChange={(e) => setMedForm({ ...medForm, pillsPerDay: e.target.value })} placeholder={isRTL ? 'في اليوم' : 'Per day'} className="flex-1 glass-card p-2.5 text-sm font-tajawal focus:outline-none focus:border-brand-green" />
                      </div>
                      <div className="flex gap-2">
