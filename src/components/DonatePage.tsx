...
import { Heart, Gift, MessageCircle, BookOpen, Sparkles, ChevronLeft, ChevronRight, ArrowRight } from 'lucide-react';
...
export default function DonatePage() {
  ...
  const [modalType, setModalType] = useState<DonationType>('medicine');
  ...
  return (
    <motion.div variants={pageVariants} initial="initial" animate="enter" exit="exit">
      <section className="min-h-screen pt-24 pb-20 px-4 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative">
          ...
          >
            ...
            <h1 className="font-cairo text-3xl sm:text-4xl font-bold mb-3">
          ...
          <div className="text-center mt-8">
            <a href="#hero" className="inline-flex items-center gap-1.5 text-sm font-tajawal text-[var(--text-muted)] hover:text-brand-green-light transition-colors">
